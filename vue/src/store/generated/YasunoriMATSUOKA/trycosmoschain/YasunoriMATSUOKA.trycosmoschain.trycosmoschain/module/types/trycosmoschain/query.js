...
const baseQueryGetSampleTypeRequest = { id: 0 };
...
const baseQueryGetSampleTypeResponse = {};
...
const baseQueryAllSampleTypeRequest = {};
...
const baseQueryAllSampleTypeResponse = {};
export const QueryAllSampleTypeResponse = {
    ...
    toJSON(message) {
        ...
        if (message.SampleType) {
            obj.SampleType = message.SampleType.map((e) => e ? SampleType.toJSON(e) : undefined);
        }
        else {
            obj.SampleType = [];
        }
...
export class QueryClientImpl {
    ...
    SampleType(request) {
        ...
        const promise = this.rpc.request("YasunoriMATSUOKA.trycosmoschain.trycosmoschain.Query", "SampleType", data);
        return promise.then((data) => QueryGetSampleTypeResponse.decode(new Reader(data)));
    }
    SampleTypeAll(request) {
        const data = QueryAllSampleTypeRequest.encode(request).finish();
        const promise = this.rpc.request("YasunoriMATSUOKA.trycosmoschain.trycosmoschain.Query", "SampleTypeAll", data);
        return promise.then((data) => QueryAllSampleTypeResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
